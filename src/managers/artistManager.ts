...
import {artistCollection} from '../objects/collection';
import {manager, SubManager} from './manager';
import {artistMenu, printArtist} from './managerEnum';
import {sortArtistName, sortArtistRep} from './sorts/artistSort';
